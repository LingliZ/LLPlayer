...
@interface LLVChatCellModel : NSObject
//  cell上面的聊天信息
...
@property (strong, nonatomic)  NSMutableAttributedString *titleAttString;
@property (strong, nonatomic)  NSMutableAttributedString *contentAttString;
@property (strong, nonatomic)  NSMutableArray* images;
@property (strong, nonatomic)  NSString *createFormatTime;
