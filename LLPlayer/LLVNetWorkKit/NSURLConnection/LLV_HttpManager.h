...
#import "LLVReachability.h"

/**
 * 默认下载并发数量
 */

extern const NSInteger kLLVDefaultDownloadNumber;

/**
 * 说明: LLV_HttpManager http请求管理类 (单例设计模式 支持POST/GET 请求 文件上传 文件下载)
 */

@interface LLV_HttpManager : NSObject
...
- (nullable LLV_DownloadOperation *)replaceCurrentDownloadOperationBlockResponse:(nullable LLVResponse)responseBlock
                                             process:(nullable LLVProgress)processBlock
...
- (nullable LLV_DownloadOperation *)replaceCurrentDownloadOperationDelegate:(nullable id<LLV_DownloadDelegate>)delegate
                                       fileName:(nonnull NSString *)fileName;
 ...
 * @param didFinishedBlock 下载完成回调
 */
- (nullable LLV_DownloadOperation *)replaceAllDownloadOperationBlockResponse:(nullable LLVResponse)responseBlock
                                         process:(nullable LLVProgress)processBlock
                                     didFinished:(nullable LLVDidFinished)didFinishedBlock;
...
- (nullable LLV_DownloadOperation *)replaceAllDownloadOperationDelegate:(nullable id<LLV_DownloadDelegate>)delegate;
