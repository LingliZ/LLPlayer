...
{
    if(!_titleColor){
        _titleColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:1.0];
    }
    return _titleColor;
}
...
- (UIColor *)highlightTitleColor
{
    if(!_highlightTitleColor){
        _highlightTitleColor = [UIColor colorWithRed:0 green:175/255.0 blue:140/255.0 alpha:1.0];
    }
...
{
    if(!_lineColor){
        _lineColor = [UIColor colorWithRed:230/255.0 green:230/255.0 blue:230/255.0 alpha:1.0];
    }
    return _lineColor;
}
