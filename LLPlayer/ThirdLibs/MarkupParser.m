...
{
    NSString *escapedString_lt = [oldString stringByReplacingOccurrencesOfString:@"&lt;" withString:@"<"];
    NSString *escapedString = [escapedString_lt stringByReplacingOccurrencesOfString:@"&gt;" withString:@">"];
