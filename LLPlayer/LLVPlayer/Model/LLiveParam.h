 ...
 *  直播服务类型
 */
typedef NS_ENUM(NSUInteger, LLiveServiceType){
    /**
     *  webcast
     */
    LLServiceTypeWebcast,
    /**
     *  training
     */
    LLServiceTypeTraining,
};

/**
 *  直播参数
 */
@interface LLiveParam : NSObject
 ...
 *  直播的服务类型
 */
@property (nonatomic, assign) LLiveServiceType serviceType;
