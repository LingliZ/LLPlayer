...
- (void)setUpWithParentView:(CGRect)frame emojiPlistFileName:(NSString*)fileName inBundle:bundle
{
    ...
    _inputTextView.layer.borderColor = [LLColorTool colorWithHexString:@"#d1d1d1"].CGColor;
    _inputTextView.layer.borderWidth = 1.0;
    _inputTextView.layer.masksToBounds = YES;
    _inputTextView.font = [UIFont systemFontOfSize:14.f];
    _inputTextView.textColor = [LLColorTool colorWithHexString:@"#999999"];
    ...
    if (fileName) {
        self.emojiCollectionView = [[GHEmojiCollectionView alloc] initWithFrame:CGRectMake(0, self.frame.size.height, frame.size.width, 150) emijiPlistFileName:fileName inBundle:bundle];
    ...
    [_sendButton setBackgroundColor:[LLColorTool colorWithHexString:@"#00c498"]];
